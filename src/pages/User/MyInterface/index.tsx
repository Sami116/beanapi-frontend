...
import {getInterfaceInfoByUserIdUsingGET} from "@/services/beanapi-backend/userInterfaceInfoController";
            ...
            <Collapse>
              <Collapse.Panel key={item.id} header={item.name} style={panelStyle}>
                ...
                >
                  ...
                  <Descriptions.Item label="可调用次数">{item.leftNum}</Descriptions.Item>
